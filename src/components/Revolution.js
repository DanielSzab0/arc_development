    ...
    return (
        <Grid container direction="column">
                ...
                <Grid item container direction="column" lg style={{maxWidth: "40rem"}}>
                    ...
                    <Grid item>
                        ...
                        <Typography align={matchesMD ? "center" : "right"} variant="body1" paragraph>
                            ...
                            them overcome life's obstacles. Each project is a step toward the goal.
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        ...
                        <Typography align={matchesMD ? "center" : undefined} variant="body1"
                                    style={{color: "#fff", maxWidth: "20rem"}} paragraph
                        >
                            Then it’s time for us to start on
                            your minimum viable product.
                            That’s just a fancy term for a
                            mockup, which doesn’t include
                ...
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    ...
                    <Grid item>
                        ...
                        >
                            ...
                            get down to the nitty gritty, fine-
                            details of design.
                        </Typography>
                    </Grid>
                </Grid>
            ...
            >
                ...
                <Grid item lg style={{alignSelf: "center"}}>
                    <img src={design} alt="paingbrush leaving stroke of paint" width="100%" style={{maxWidth: 1000}}/>
                </Grid>
            </Grid>
            {" "}
            {/*-----Review 2 Block-----*/}
            ...
            >
                ...
                <Grid item lg style={{alignSelf: "center"}}>
                    <img src={build} alt="building constuction site" width="100%" style={{maxWidth: matchesMD ? 700 : 1000}}/>
                </Grid>
            </Grid>
            {" "}
            {/*-----Launch Block-----*/}
